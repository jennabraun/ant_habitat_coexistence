...
four.comb.ants.adj <- fourthcorner(evn4C, spe.bin,
traits.spe, modeltype = 6, p.adjust.method.G = "none",
p.adjust.method.D = "fdr", nrepet = 999)

## Hmm look into different models more
four.comb.ants.adj 
...
library(mvabund)
fit <- traitglm(spe.bin, evn4C, traits.spe, family = "binomial", method = "glm1path")
...
cor.test(cov$mean.cover, cov$esi)
